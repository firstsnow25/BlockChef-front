 ...
 * 공통: 상수/메타
 * ========================================= */
// ✅ 각진 플러그(0=round, 1=square, 2=hex). 안전하게 숫자만 사용.
...
// 재료 feature 메타 (semantics.js에서 사용)
...
/** =========================================
 * 재료 이름 블록(값)
 *  - 출력 타입: ING_NAME (재료 '이름' 전용)
 *  - 출력 플러그: 각진 모양
 *  - data 에 features 메타 저장
 * ========================================= */
...
Blockly.Blocks["ingredient_block"] = {
  init() {
    this.appendValueInput("NAME")
      .appendField("재료")
      .setCheck("ING_NAME"); // 재료 '이름'만 연결 가능
    ...
    this.setOutput(true, "ING"); // 완성 재료 타입
    this.setStyle("ingredient_blocks");
...
/** =========================================
 * 동작 블록들
 *  - 모든 ITEM 입력: ING만 허용 (재료 이름 단독 사용 금지)
 *  - value 버전은 출력도 ING (파이프라인 구성 지원)
 * ========================================= */
// 기다리기 (시간만, statement)
